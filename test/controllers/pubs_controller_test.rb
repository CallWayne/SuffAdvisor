...
class PubsControllerTest < ActionController::TestCase
  ...
  test "should create pub" do
    assert_difference('Pub.count') do
      post :create, pub: { address: @pub.address, description: @pub.description, place: @pub.place, title: @pub.title }
    end
  ...
  test "should update pub" do
    patch :update, id: @pub, pub: { address: @pub.address, description: @pub.description, place: @pub.place, title: @pub.title }
    assert_redirected_to pub_path(assigns(:pub))
  end
